...
<head>
	...
	<style>
		* {
        ...
        .zerosection {
			background-color: rgb(253, 205, 143);
			height: 200px;
		}

		.firstsection {
			background-color: rgb(193, 253, 143);
			height: 400px;
		}
...
<body>
	<nav class="navbar background">
		<ul class="nav-list">
			<div class="logo">
				<img style="width:150px" src= "https://www.pngitem.com/pimgs/m/453-4531530_devops-and-the-agility-of-a-startup-devops.png">
			</div>
	...
	<section class="zerosection">
		<div class="box-main">
			<div class="firstHalf">
                <h1 class="text-big" id="dynamic" >Today is <fmt:formatDate type = "both" dateStyle = "long" timeStyle = "long" value = "${today}" /></h1>
			</div>
		</div>
	</section>
	...
	<section class="section">
		...
		<div class="thumbnail">
			<img style="width: 150px" src= "https://cdn-icons-png.flaticon.com/512/226/226777.png" alt="laptop image">
		</div>
	</section>
